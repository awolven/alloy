...
(defun pxx (geometry) (coerce (to-px (x geometry)) 'single-float))
(defun pxy (geometry) (coerce (to-px (y geometry)) 'single-float))
(defun pxw (geometry) (coerce (to-px (w geometry)) 'single-float))
(defun pxh (geometry) (coerce (to-px (h geometry)) 'single-float))
(defun pxl (geometry) (coerce (to-px (l geometry)) 'single-float))
(defun pxu (geometry) (coerce (to-px (u geometry)) 'single-float))
(defun pxr (geometry) (coerce (to-px (r geometry)) 'single-float))
(defun pxb (geometry) (coerce (to-px (b geometry)) 'single-float))
